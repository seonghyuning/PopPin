    ...
    <body>
        <%@ include file="../includes/header.jsp" %>
            ...
            <div class="listBtn">
                ...
                <button class="myPageFilterBtn" onclick="window.location.href='/mypage/popupstore/manage'">신청
                    팝업</button>
            </div>
            ...
            <div class="cardListContainer" onclick="">
                <div class="cardListItem">
                    ...
                    <div class="cardContent">
                        ...
                        <p class="locationText"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <button class="likeButton listButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
