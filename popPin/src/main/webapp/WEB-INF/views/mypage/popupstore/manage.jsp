		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			...
			<body>
				<%@ include file="../../includes/header.jsp" %>
					...
					<div class="listBtn">
						<button class="myPageFilterBtn" onclick="window.location.href='/member/mypage'">관심 팝업</button>
						<div id="middleLine"></div>
						<button class="myPageFilterBtn" onclick="window.location.href='/mypage/popupstore/manage'">신청 팝업</button>
					</div>
					<button class="loginBtn" id="storeRegButton" onclick="window.location.href='/mypage/popupstore/new'">내 팝업스토어
						등록하기
					</button>
									...
									<div class="cardContent">
										...
										<div class="cardActions">
											...
											<form action="/mypage/popupstore/delete" method="post" style="display: inline;">
												...
												<button type="submit" id="deleteBtn" onclick="return confirm('정말 삭제하시겠습니까?')">삭제</button>
											</form>
										</div>
									</div>
