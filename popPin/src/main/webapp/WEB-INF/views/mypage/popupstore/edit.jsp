...
<body>
    <div class="edit-container">
        <h1>팝업스토어 수정</h1>
        <form class="loginForm" action="/mypage/popupstore/edit" method="post" enctype="multipart/form-data">
         ...
         <input type="button" onclick="sample5_execDaumPostcode()" value="주소 검색"><br>
            ...
            <input type="text" id="description" name="description" value="${popupStore.description}" required></input>
            ...
            <div id="currentImages">
                <c:forEach var="image" items="${images}">
                    <div class="image-wrapper">
                        ...
                        <input type="hidden" name="existingImages" value="${image.imageId}" id="hiddenImage-${image.imageId}" />
                        <button type="button" data-id="${image.imageId}" onclick="removeImage(this)">X</button>
                    </div>
                </c:forEach>
            </div>
