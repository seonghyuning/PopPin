	...
	<div class="edit-container">
		...
		<form class="loginForm" action="/mypage/popupstore/edit" method="post"
			...
			<label for="userName">스토어 이름</label> <input type="text" id="name"
				name="name" value="${popupStore.name}" required /> <label
				for="location">위치</label> <input type="text" id="location"
			...
			<label for="description">설명</label> <input type="text"
				...
				value="${popupStore.description}" required></input> <label
			...
			<label for="newImages">새 이미지 업로드</label> <input type="file"
				id="newImages" name="newImages" multiple
