    ...
    <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
        ...
        <nav id="header">
            ...
            <form action="/store/search" method="get">
                <input type="search" name="keyword" id="searchBar" placeholder="지역, 팝업스토어 이름 입력"
                    value="${param.keyword}">
            ...
            <div>
                ...
                <a href="/member/mypage"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <sec:authorize access="isAnonymous()">
                    <!-- 비로그인 상태 -->
                    <button type="button" class="loginBtn" onclick="window.location.href='/member/login'">회원가입 /
                        로그인</button>
                </sec:authorize>
            </div>
        </nav>
